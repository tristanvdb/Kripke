...
struct Policy_LTimes<ArchLayoutT<ArchT_OpenMP, LayoutT_DZG>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<0,3,4,5>, // Moment Zones k:j:i
        For<1, loop_exec, // Direction
          For<2, loop_exec, // Group
            Lambda<0>
          >
...
struct Policy_LTimes<ArchLayoutT<ArchT_OpenMP, LayoutT_GZD>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<2,3,4,5,0>, // Group Zones k:j:i Moment
...
struct Policy_LTimes<ArchLayoutT<ArchT_OpenMP, LayoutT_ZDG>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<3,4,5,0>, // Zones k:j:i Moment
        For<1, loop_exec, // Direction
          For<2, loop_exec, // Group
            Lambda<0>
          >
...
struct Policy_LTimes<ArchLayoutT<ArchT_OpenMP, LayoutT_ZGD>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<3,4,5,2>, // Zones k:j:i Group
        For<0, loop_exec, // Moment
          For<1, loop_exec, // Direction
            Lambda<0>
          >
