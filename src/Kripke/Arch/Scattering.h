...
struct Policy_Scattering<ArchLayoutT<ArchT_OpenMP, LayoutT_DZG>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<0,3,4,5,1>, // Moment, Zones k:j:i, DstGrp
        For<2, loop_exec, // SrcGrp
          Lambda<0>
        >
      >
...
struct Policy_Scattering<ArchLayoutT<ArchT_OpenMP, LayoutT_GZD>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<1,3,4,5>, // DstGrp, Zones k:j:i
        For<2, loop_exec, // SrcGrp
          For<0, loop_exec, // Moment
            Lambda<0>
          >
...
struct Policy_Scattering<ArchLayoutT<ArchT_OpenMP, LayoutT_ZDG>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<3,4,5,0,1>, // Zones k:j:i, Moment, DstGrp
        For<2, loop_exec, // SrcGrp
          Lambda<0>
        >
      >
...
struct Policy_Scattering<ArchLayoutT<ArchT_OpenMP, LayoutT_ZGD>> {
  using ExecPolicy =
    KernelPolicy<
      Collapse<omp_parallel_collapse_exec, ArgList<3,4,5,1>, // Zones k:j:i, DstGrp
        For<2, loop_exec, // SrcGrp
          For<0, loop_exec, // Moment
            Lambda<0>
          >
